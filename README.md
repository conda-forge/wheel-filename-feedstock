...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/wheel-filename-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15425&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/wheel-filename-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `wheel-filename` can be installed with:

```
conda install wheel-filename
```

It is possible to list all of the versions of `wheel-filename` available on your platform with:
